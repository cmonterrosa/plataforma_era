class CreateEvaluacions < ActiveRecord::Migration
  def self.up
    create_table :evaluacions do |t|
      ...
      t.decimal :puntaje_eje1, :precision=> 15, :scale=> 3
      t.decimal :puntaje_eje2, :precision=> 15, :scale=> 3
      t.decimal :puntaje_eje3, :precision=> 15, :scale=> 3
      t.decimal :puntaje_eje4, :precision=> 15, :scale=> 3
      t.decimal :puntaje_eje5, :precision=> 15, :scale=> 3
